...
class WhatsAppMessageService
{
    ...
    public function for_hafiz_sendWhatsAppMessage($customer_mobile_number, $customer_name, $item_name, $qty, $price, $date)
    {
        try {
    ...
    public function for_shafqat_sendWhatsAppMessage($customer_mobile_number, $customer_name, $item_name, $qty, $price, $date)
    {
        try {
            $client = new \GuzzleHttp\Client();

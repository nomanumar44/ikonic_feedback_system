                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" @input="updateField('name', $event.target.value)"
                                                            :value="edit == 1 ? user.name : accountCode" class="form-control" id="txtCityName"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" @input="updateField('email', $event.target.value)"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" @input="updateField('password', $event.target.value)"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group text-right">
                                                        <button @click="addUpdateCoa1()" :disabled="loading"
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <img src="/img/doctor.png" class="user-avatar" alt="User Avatar" width="250" height="250" v-if="user.image == ''">
                                        <img :src="user.image" class="user-avatar" alt="User Avatar" width="250" height="250" v-if="user.image != ''">
                                    </div>
